...
> **在体系中的位置**：导览。先读 [架构总览与决策指南](overview.md)；本页是企业级需求的速查导览，链接 [模块化单体](modular-monolith.md)/[DDD](ddd.md)/[CQRS](cqrs.md)/[多租户](multi-tenancy.md)/[审计与软删除](auditing-soft-delete.md)/[事件驱动](event-driven.md) 等。

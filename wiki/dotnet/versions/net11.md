...
.NET 11 目前处于**预览阶段**（本页依据 Preview 5，2026-06），预计 **2026 年 11 月正式发布**，是 **STS（标准期限支持）** 版本，对应 **C# 15**。按 [POLICY P12](../../governance/policy.md) 与「预览特性不写成稳定承诺」的时效约定，**预览特性不写成稳定承诺**：本页仅作前瞻，API 与行为在 GA 前仍可能变化。**生产项目请继续用 [.NET 10 LTS](../overview.md)**（GA 于 2025-11，支持到 2028）。

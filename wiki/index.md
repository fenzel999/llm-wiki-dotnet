...
- [最小 API 验证](dotnet/aspnet-core/minimal-api-validation.md) — 内置校验与自动 400
...
## 规范
- [命名规范](standards/naming.md) — 类型/成员/变量命名约定
- [异常处理规范](standards/exception-handling.md) — 抛/捕/包装的正确姿势
- [日志规范](standards/logging.md) — 结构化日志与级别
- [配置规范](standards/configuration.md) — Options 绑定与校验
- [单元测试规范](standards/unit-testing.md) — 可维护测试结构
...
- [思维导图](思维导图.md) · [知识图谱 3D](知识图谱3D.md)

...
- :material-checkbox-multiple-marked: **规范与模式**
  ...
  [进入](standards/coding-conventions.md)

- :material-alert-octagon: **反模式**
  吞异常、async void、魔法数字、阻塞异步、过早优化
  [进入](anti-patterns/design-antipatterns.md#swallowing-exceptions)
...
- **工程层**：[规范](standards/coding-conventions.md) · [反模式](anti-patterns/design-antipatterns.md#swallowing-exceptions) · [对比](comparisons/record-vs-class.md)
